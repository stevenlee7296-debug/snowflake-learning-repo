...
JOIN tasty_bytes.raw_pos.franchise f
    ON t.franchise_id = f.franchise_id
where first_name = 'Sara'    and last_name = 'Nicholson';

CREATE VIEW tasty_bytes.harmonized.truck_franchisee
    AS
SELECT
    t.*,
    f.first_name AS franchisee_first_name,
...
describe view tasty_bytes.harmonized.truck_franchisee;


drop view tasty_bytes.harmonized.truck_franchisee;


create materialized view tasty_bytes.harmonized.truck_franchise_materialized
as 
SELECT
    t.*,
    f.first_name AS franchisee_first_name,
